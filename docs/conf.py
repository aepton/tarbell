...
project = u'Tarbell'
copyright = u'2013, News Apps and David Eads'
...
latex_documents = [
  ('index', 'Tarbell.tex', u'Tarbell Documentation',
   u'News Apps and David Eads', 'manual'),
]
...
texinfo_documents = [
  ('index', 'Tarbell', u'Tarbell Documentation',
   u'News Apps and David Eads', 'Tarbell', 'One line description of project.',
   'Miscellaneous'),
]
